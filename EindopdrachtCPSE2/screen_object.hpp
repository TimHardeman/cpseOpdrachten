...
public:
	...
	// Returns the objects color, not pure virtual since picture has no color.
	virtual sf::Color returnColor() = 0;
	
	// Changes the objects color, not pure virtual since picture has no color.
	virtual void changeColor(sf::Color newColor) = 0;
